...
addon_info = {
	...
	"addon_name" : "DBeaver-eclipse-nvda",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary" : _("DBeaver Eclipse NVDA"),
	# Add-on description
	...
	# Author(s)
	"addon_author" : u"Jean Braz <jeanbrazcosta@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/jeanbrazcosta/DBeaver-eclipse-nvda",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/jeanbrazcosta/DBeaver-eclipse-nvda",
